...
with aba[1]:
    ...
    st.markdown(
        f"""<div class="indicator-grid">
            ...
            <div class="indicator-card"><div class="indicator-top">Score financeiro <span class="indicator-icon">S</span></div><div class="indicator-value">{score_dashboard}/100</div><div class="indicator-note">Combina saldo, dívidas, reserva e metas.</div><div class="progress-track"><span style="width:{limitar_percentual(score_dashboard)}%"></span></div></div>
            <div class="indicator-card"><div class="indicator-top">Taxa de sobra <span class="indicator-icon">+</span></div><div class="indicator-value">{pct(taxa_sobra_dashboard)}</div><div class="indicator-note">Parte das entradas que virou saldo.</div><div class="progress-track"><span style="width:{limitar_percentual(taxa_sobra_dashboard)}%"></span></div></div>
            ...
            <div class="indicator-card"><div class="indicator-top">Reserva estimada <span class="indicator-icon">R</span></div><div class="indicator-value">{reserva_meses_texto} meses</div><div class="indicator-note">Investimentos divididos pela média de saídas.</div><div class="progress-track"><span style="width:{reserva_percentual}%"></span></div></div>
        </div>""",
        unsafe_allow_html=True,
    )
...
st.caption("Dashboard Financeiro • Visão financeira clara • Experiência premium")    f"url('data:image/jpeg;base64,{bg_base64}') center/cover fixed no-repeat"
    if bg_base64
    else "linear-gradient(160deg, #071b51, #183f73, #e09d9b)"
)
