...
def style_plot(fig, height=400, show_legend=True):
    fig.update_layout(
        ...
        legend=dict(
            ...
            font=dict(size=11, color="#1c1f26"),
    ...
    fig.update_xaxes(gridcolor="rgba(28,31,38,0.06)", tickfont=dict(color="#8a90a0", size=11), zeroline=False)
    fig.update_yaxes(gridcolor="rgba(28,31,38,0.06)", tickfont=dict(color="#8a90a0", size=11), zeroline=False)
    return fig
        ...
        with c1:
            ...
            fig = px.pie(
                ...
                color_discrete_sequence=[
                    ...
                    "#b8f0d8", "#c5c9d4", "#f3ff9a", "#6b7280", "#e8faf3",
                ],
            )
            fig.update_traces(
                textposition="outside",
                textinfo="percent",
                textfont=dict(size=12, color="#1c1f26"),
